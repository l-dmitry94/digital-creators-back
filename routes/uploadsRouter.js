...
uploadsRouter.patch('/background', changeBackground); //here use query parametr. Example (image = "water_surface").Full example(http://localhost:3000/api/user/background?image=water_surface)
